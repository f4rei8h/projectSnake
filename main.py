...
def Your_score(score):
    value = score_font.render(str(score) + " Баллов", True, black)
    dis.blit(value, [7, 5])
...
def gameLoop():
    ...
    while not game_over:
        ...
        while game_close == True:
            dis.fill(white)
            message1("Нажмите на Пробел чтобы начать заного", red)
            message2("Нажмите на клавишу Esc чтобы покинуть игру ", red)
